...
/* Wireless extensions removed in Linux 6.1+ */
#define IWE_STREAM_ADD_EVENT(_A, _B, _C, _D, _E)		(_B)
#define IWE_STREAM_ADD_POINT(_A, _B, _C, _D, _E)		(_B)
#define IWE_STREAM_ADD_VALUE(_A, _B, _C, _D, _E, _F)	(_B)
#elif (KERNEL_VERSION(2, 6, 27) <= LINUX_VERSION_CODE)
